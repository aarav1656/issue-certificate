...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _safeMint(
        ...
        _mint(to, tokenId);
        require(_checkOnERC721Received(address(0), to, tokenId, data), "OZ:19");
    }
...
contract PROBINAR is ERC721, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;
    ...
    mapping(uint256 => bool) public isCertificateValid;
    ...
    function tokenURI(uint256 CertificationID)
        public
        view
        virtual
        override
    ...
    {
        require(
            isCertificateValid[CertificationID],
            "Certification ID not exist"
        );
